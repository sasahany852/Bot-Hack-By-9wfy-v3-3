...
client.on("ready", () => {
    ...
    console.log(red('           ════════════════════════════════════════════════════════════════════════════════'));
    console.log("");
    client.user.setActivity({ type: "PLAYING", name: prefix + 'help | By 9wfy' }); // Delete this if you wish.
});
...
\` [text]
            ...
            **Server Annihilation:** \`${prefix}die\` [text]
            `)
            .setThumbnail(`https://cdn.discordapp.com/attachments/853760657835950094/853769995255283712/gd.png`)
